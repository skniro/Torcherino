...
public record WeatheringCopperBlocks(Block unaffected, Block exposed, Block weathered, Block oxidized, Block waxed, Block waxedExposed, Block waxedWeathered, Block waxedOxidized) {
    public static <WaxedBlock extends Block, WeatheringBlock extends Block & WeatheringCopper> WeatheringCopperBlocks create(final String id, final TriFunction<String, Function<BlockBehaviour.Properties, Block>, BlockBehaviour.Properties, Block> register, final Function<BlockBehaviour.Properties, WaxedBlock> waxedBlockFactory, final BiFunction<WeatheringCopper.WeatherState, BlockBehaviour.Properties, WeatheringBlock> weatheringFactory, final Function<WeatheringCopper.WeatherState, BlockBehaviour.Properties> propertiesSupplier) {
        Block var10002 = (Block)register.apply(id, (Function)(p) -> (Block)weatheringFactory.apply(WeatheringCopper.WeatherState.UNAFFECTED, (BlockBehaviour.Properties) p), (BlockBehaviour.Properties)propertiesSupplier.apply(WeatheringCopper.WeatherState.UNAFFECTED));
        Block var10003 = (Block)register.apply("exposed_" + id, (Function)(p) -> (Block)weatheringFactory.apply(WeatheringCopper.WeatherState.EXPOSED, (BlockBehaviour.Properties) p), (BlockBehaviour.Properties)propertiesSupplier.apply(WeatheringCopper.WeatherState.EXPOSED));
        Block var10004 = (Block)register.apply("weathered_" + id, (Function)(p) -> (Block)weatheringFactory.apply(WeatheringCopper.WeatherState.WEATHERED, (BlockBehaviour.Properties) p), (BlockBehaviour.Properties)propertiesSupplier.apply(WeatheringCopper.WeatherState.WEATHERED));
        Block var10005 = (Block)register.apply("oxidized_" + id, (Function)(p) -> (Block)weatheringFactory.apply(WeatheringCopper.WeatherState.OXIDIZED, (BlockBehaviour.Properties) p), (BlockBehaviour.Properties)propertiesSupplier.apply(WeatheringCopper.WeatherState.OXIDIZED));
