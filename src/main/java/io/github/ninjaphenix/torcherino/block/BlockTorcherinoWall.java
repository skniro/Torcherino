...
public class BlockTorcherinoWall extends BlockTorchWall implements ITileEntityProvider
{
    private int SPEED;
    public BlockTorcherinoWall()
    {
        super(Builder.create(Material.CIRCUITS).doesNotBlockMovement().zeroHardnessAndResistance().lightValue(14).sound(SoundType.WOOD));
    }
    public BlockTorcherinoWall(int speed)
    {
        this();
        SPEED = speed;
    }
